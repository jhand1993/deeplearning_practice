...
class CatDogDataSet(Dataset):
    """ PyTorch DataSet class for loading cat and dog Kaggle training set. 
        If there are 1000 total images indexed 0, 1, 2, ..., 999, then the first 500 
        are in the cat subpath, and the remainder in the dog subpath. 
    """
    def __init__(
        ...
        paths = list(self.cat_path.glob('*.jpg')) + list(self.dog_path.glob('*.jpg'))
